...
\psst{Time} is also used for special clock time constructions, e.g.~identifying 
a time via an offset:
\begin{exe}
  \ex The alarm rang at a quarter \p{of}/\p{to} 8.\nss{this use of \p{to} is \rf{Time}{EndTime} in the data. what about \p{of}?}
  \ex The alarm rang at half \p{past} 8.\nss{is this a prep?}
...
\begin{exe}
  ...
  \end{xlist}
  \ex \rf{Originator}{Possessor}\nss{change to \rf{Originator}{Gestalt}?}: \begin{xlist}
