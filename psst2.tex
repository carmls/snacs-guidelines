...
is available at \url{https://github.com/nert-gu/streusle/}.
\end{abstract}
...
unlike \p{of}, is never analyzed with \psst{Whole} as the scene role, 
...
\begin{exe}
  ...
  \end{xlist}
  \ex \choices{Shakespeare\p{'s}\\\p{his}} works [items that the creator or transferer possesses (at least initially)] (\rf{Originator}{Possessor})
