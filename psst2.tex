...
\title{Adposition and Case Supersenses v2.5pre:\\ Guidelines for English}
...
The v2.5 hierarchy is a tree with 50~labels.
...
\begin{history}
  ...
  while \sst{OrgRole} was split into \psst{Org} and \psst{OrgMember}
...
\begin{itemize}
  ...
  and clearer annotation guidelines:
  \begin{itemize}
