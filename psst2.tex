...
\begin{itemize}
  ...
  \begin{itemize}
    \item Several more possessive clarifications under \psst{Gestalt}, \psst{Possessor}, \fullref{sec:genitives} (GitHub issues \ghi{32}, \ghi{33}, \ghi{34}, \ghi{35}, \ghi{37}, \ghi{38})
  \end{itemize}
...
\begin{exe}
  ...
  \begin{exe}
    \ex They are \choices{\p{on} a journey\\\lex[on\_the\_way]{\p{on}\_~~the~~\_way}\\\lex*[on\_their\_way]{\p{on}\_~~their~~\_way}\p{on}\_~~their$_{\text{\backposs}}$~~\_way}  (\rf{Circumstance}{Locus})
  \end{exe}
