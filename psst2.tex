...
In a commercial transaction scene, the preposition introducing the item or event 
...
\begin{exe}
  \ex I prefer this restaurant \p{over} the one across the street. (\rf{ComparisonRef}{Locus})
\end{exe}
