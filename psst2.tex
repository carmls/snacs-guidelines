...
\newcommand{\psstX}[2]{\textcolor{mdgreen}{\hyperref[sec:#1]{\sst{#2}}}} % preposition supersense tag label
...
\begin{exe}
  ...
  \ex We were looking \p{at} the photo. (\rf{Stimulus}{Direction})
  \ex I startled \p{at} the noise (\rf{Stimulus}{Goal})\nss{Direction?}
  \ex I care \p{about} you (\rf{Stimulus}{Topic})
  \ex\rf{Stimulus}{Topic}:\begin{xlist}
