...
\title{Adposition and Case Supersenses v2.4:\\ Guidelines for English}
...
as demonstrated in the STREUSLE corpus (\url{https://github.com/nert-gu/streusle/}; version~4.2 will track guidelines version~2.4).
