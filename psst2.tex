...
the items/parts:
\begin{exe}
  \ex\label{ex:diverserange} Everyone \p{from}$_{\text{\rf{Part/Portion}{Source}}}$ the peasants 
...
\begin{exe}
  \ex\begin{xlist}
    \ex\label{ex:toSumItUp} \p{To} sum it up: It was a terrible experience.
