...
\shortdef{The form that something takes or the style in which an action is performed.\nss{was: 
Description of \textbf{how} something happens or exists
...
\begin{exe}
  \ex I made the decision \p{by} myself. (see \cref{sec:refl})
