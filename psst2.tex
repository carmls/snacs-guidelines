...
\begin{itemize}
  \item \emph{Version 2.3pre (\nss{release date TBD}):} %\emph{Since the \textbf{July 2, 2018} version:}
  \begin{itemize}
...
\item	Anything that is borderline between the \psst{Possession} and \mbox{\psst{PartPortion}} subcategories.
  \item \nss{rev: from here} The \textbf{state or condition} that an entity is in. 
