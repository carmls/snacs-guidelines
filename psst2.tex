...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Clarified \psst{Locus}, \psst{Source}, \psst{Goal}, \psst{Path}, and 
      \psst{Direction}, especially with regard to (i)~intransitive prepositions and (ii)~distance measurements.
    ...
    \item Added discussion of special syntactic constructions (\cref{sec:cxns}).
