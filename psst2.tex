...
an inventory of 51~semantic labels (``supersenses'')
...
Contrast \psst{Content}, which applies to propositions describing or quotations from a message or thought.
...
\begin{history}
  ...
  In v2.6, \psst{Content} was split off from \psst{Topic}, 
  in part to accommodate languages (such as Korean) with adpositional quotative marking.
\end{history}

\hierBdef{Content}

\shortdef{What is thought or communicated.}

This label is for communicative or mental information content---i.e., a message or contemplated proposition:
...
\begin{history}
  In v2.6 this was split off from \psst{Topic}. 
