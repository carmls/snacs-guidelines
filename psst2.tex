...
\begin{itemize}
  ...
  \item When something is accomplished without assistance:
    \begin{exe}
      \ex I can now ride a bike (all) \p{by} myself! (\rf{Agent}{Accompanier})
      \ex The computer rebooted all \p{by} itself. (\rf{Agent}{Accompanier})
    \end{exe}
\end{itemize}
