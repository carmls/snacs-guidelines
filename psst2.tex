...
\begin{itemize}
  ...
  \begin{itemize}
    \item Added \cref{sec:constraints}: Constraints on Role and Function Combinations.
    \item A few additional examples.
...
and criticism about someone who is absent is not yelling at them.})
  ...
  \ex Timmy\p{'s} piano lesson (\rf{Recipient}{Possessor})
...
\rf{Recipient}{Possessor} construals, respectively. 
\begin{xexe}
  ...
  \ex\label{ex:RecPoss} Sam\p{'s} receipt of the box (\rf{Recipient}{Possessor})
\end{xexe}
...
\textbf{Temporal supersenses never occur with a function of \psst{Locus}, \psst{Path}, or \psst{Extent}.}
...
construals on temporal adpositions. Thus:
\begin{xexe}
...
\begin{xexe}
  ...
  \ex Will you attend Saturday\p{'s} class? (\rf{Time}{Possessor})
  \ex It took a year\p{'s} work to finish the book. (\rf{Duration}{Possessor})
\end{xexe}
