...
brought about thanks to the availablility of an entity,
...
\begin{itemize}
  ...
  These are labeled \psst{Purpose}. Some be paraphrased with \p{in\_order\_to}.
  ...
  licenses an infinitival, labeled \rf{ComparisonRef}{Purpose} or \rf{ComparisonRef}{Goal}.
