...
\begin{exe}
    ...
    \ex \p*{As}{as} meaning `when' or `while':\begin{xlist}
      \ex I ran into her \p{as} I was leaving.\nss{seems like Time}
      \ex \p*{As}{as} we watched, she transformed into a cat.
      \ex We will continue to update you \p{as} information arrives. 
    \end{xlist}
  \end{exe}
