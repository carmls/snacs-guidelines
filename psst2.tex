...
\begin{exe}
  ...
  \ex \rf{Stimulus}{Direction}:
    ...
    \end{xlist}
  \ex \rf{Stimulus}{Topic} \jh{edit} are assigned to cases where the PP describes the topic or content of one's emotion: 
    \begin{xlist}
      \ex I care \p{about} you.
      \ex I was happy \p{with} the results.
...
\subsubsection{Reflexive PP Idioms}
...
\begin{exe}
  \ex\begin{xlist}
    \ex I shot the sheriff \w{\p{as}\_well}.
    \ex They serve coffee, and tea \w{\p{as}\_well}.
  \end{xlist}
\end{exe}
