...
\begin{itemize}
  ...
  \item passive \p{by} requires \psst{Agent} or \psst{Force} as its function (\cref{sec:passives})
\end{itemize}
...
\begin{itemize}
  \item \emph{Version 2.6 (June 18, 2022):} % forgot to update some examples in the June 15 release
  \begin{itemize}
