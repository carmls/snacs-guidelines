...
\begin{exe}
    \ex\begin{xlist}
      \ex The strategy \choices{is beneficial \\ is risky} \p{for} investors. (\psst{Beneficiary})
      \ex The strategy \choices{is helpful \\ poses a risk} \p{to} investors. (\rf{Beneficiary}{Goal})
    \end{xlist}
\end{exe}
